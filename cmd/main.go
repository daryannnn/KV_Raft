...
//HTTP эндпоинты для манипуляции state machine через Raft кластер
...
//Связываем воедино state machine и http api, чтобы непосредственно считывать конфигурацию из cmd и запускать Raft ноду и http api
